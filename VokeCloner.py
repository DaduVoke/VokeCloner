...
sprint (bcolors.OKCYAN + "გამარჯობათ. tool-ი შექმინლია ლევან ყიფიანი-DคᖙuvͥØkͣeͫ-ის მიერ. აღნიშნული ხელაწყო შექმნილია მხოლოდ სასწავლო მიზნებისთვის. დაკოპირებული URL იქნება იმავე დირექტორიაში სადაც პროგრამაა შენახული" + bcolors.BOLD)
     ...
     def compare_site(self):
        ...
        try:
            if new_content.split("</head>")[1] != old_content.split("</head>")[1] or new_content.split("</HEAD>")[1] \
                ...
                print(bcolors.OKCYAN +"საიტზე მოხდა განახლება" + bcolors.BOLD)
            ...
            print(bcolors.OKBLUE + "მოხდა შეცდომა" + bcolors.BOLD)
            pass
