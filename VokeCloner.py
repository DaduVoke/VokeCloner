...
sprint (bcolors.OKCYAN + "მოგესალმებით აღნიშნული ხელაწყო შექმნილია მხოლოდ სასწავლო მიზნებისთვის. დაკოპირებული URL იქნება იმავე დირექტორიაში სადაც პროგრამაა შენახული DคᖙuvͥØkͣeͫ" + bcolors.BOLD)
